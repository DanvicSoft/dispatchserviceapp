...
<html lang="en">
    <head>
        ...
        <title>Find Dispatch Riders</title>
    </head>
    <body class="mb-48">
                    ...
                    <form method="POST" action="/createuser">
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                type="text"
                                class="border border-gray-200 rounded p-2 w-full"
                                name="location" placeholder="Enter locaion e.g Rumoukoro"
                            />
                            @error('location')
                            <p class="text-red-500 text-xs mt-1">{{$message}}</p>    
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                type="password"
                                class="border border-gray-200 rounded p-2 w-full"
                                name="password2" placeholder="please enter password"
                            />
                            @error('password2')
                            <p class="text-red-500 text-xs mt-1">{{$message}}</p>    
                            @enderror
        ...
        >
            ...
            <a
                href="#"
                class="absolute top-1/3 right-10  text-white py-2 px-5"
                ></a
            >
        </footer>
    </body>
